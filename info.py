...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://jaiveer55:jaiveer2010@bot.n7enhyk.mongodb.net/?retryWrites=true&w=majority&appName=bot")
...
URL = "https://vj-filter-bot-1-nsoa.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://vj-filter-bot-1-nsoa.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://vj-filter-bot-1-nsoa.onrender.com/".format(FQDN)
else:
    URL = "https://vj-filter-bot-1-nsoa.onrender.com/".format(FQDN)
