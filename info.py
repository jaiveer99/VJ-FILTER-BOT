...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1184881459')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002009244378')
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '1184881459')
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '1184881459')
...
DATABASE_NAME = environ.get('DATABASE_NAME', "jaiveer4545")
...
SHORTLINK_API = environ.get('SHORTLINK_API', '102bc6109a5b497862d78b4a958dc775d67787ee')
...
URL = "https://movie-bot-2-0-1g81.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://movie-bot-2-0-1g81.onrender.com/".format(FQDN, PORT)
SLEEP_THRESHOLD = int(environ.get('SLEEP_THRESHOLD', '60'))
WORKERS = int(environ.get('WORKERS', '4'))
SESSION_NAME = str(environ.get('SESSION_NAME', 'StreamBot'))
MULTI_CLIENT = False
name = str(environ.get('name', 'jaibots'))
PING_INTERVAL = int(environ.get("PING_INTERVAL", "500"))  # 20 minutes
if 'DYNO' in environ:
    ON_HEROKU = True
...
if HAS_SSL:
    URL = "https://movie-bot-2-0-1g81.onrender.com/".format(FQDN)
else:
    URL = "https://movie-bot-2-0-1g81.onrender.com/".format(FQDN)
