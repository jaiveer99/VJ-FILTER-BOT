...
URL = "https://vj-filter-bot-t7xw.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://vj-filter-bot-t7xw.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://vj-filter-bot-t7xw.onrender.com/".format(FQDN)
else:
    URL = "https://vj-filter-bot-t7xw.onrender.com/".format(FQDN)
