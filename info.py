...
URL = "https://movie-bot-2-0-f23i.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://movie-bot-2-0-f23i.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://movie-bot-2-0-f23i.onrender.com/".format(FQDN)
else:
    URL = "https://movie-bot-2-0-f23i.onrender.com/".format(FQDN)
